...
\end{align*}
\\
\text{to prove 1.2.1 A should be symmentrical.}
\begin{align*}
...
\end{align*}
\begin{align*}
f(\vec{y}) = \norm{b}^2 + (3\lambda_1 ^2 + 9\lambda_2^2 - 6\lambda_1\lambda_2 - 10\lambda_2 - 4\lambda_1)
\end{align*}
\begin{align*}
\frac{df\brak{\vec{y}}}{d\vec{y}} = \myvec{6\lambda_1 - 6\lambda_2 - 4 \\ -18\lambda_2 + 6\lambda_1 + 10} = \myvec{0 \\ 0}
\end{align*}
\begin{align*}
 \myvec{3\lambda_1 - 3\lambda_2  \\ -9\lambda_2 + 3\lambda_1} = \myvec{2 \\ -5}
\end{align*}
\begin{align*}
M^TM=\begin{pmatrix}
3 & 3\\
